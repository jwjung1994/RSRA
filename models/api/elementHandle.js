...
exports.loadElementTable = function(){
...
exports.addElement = function(req){
  return new Promise(function(resolve){
    var eles = new Elements();
    eles.stage = req.selectedStage;
    eles.elements = req.main_element;
    eles.sub_elements1 = req.sub_element1;
    eles.sub_elements2 = req.sub_element2;
    eles.sub_elements3 = req.sub_element3;
    eles.instance = req.instance;
...
exports.deleteRow = function(rowId){
    return new Promise(function(resolve){
      Elements.deleteOne({ _id : rowId }, function(err){
        if(err){
          console.log(err);
        }
        resolve('end');
